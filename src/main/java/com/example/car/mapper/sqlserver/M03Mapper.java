...
public interface M03Mapper {
    ...
    List<M03>selectM03Unable(@Param("carNumber") String carNumber, @Param("recId") String recId,
                             @Param("phone") String phone,@Param("MustId")String MustId);

    List<CarStatus>selectM03StatusUnable(@Param("MustId")String MustId,@Param("name")String name);
